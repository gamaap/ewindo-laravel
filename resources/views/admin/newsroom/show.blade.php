<x-admin.layout>
    ...
    <div class="flex flex-col items-center gap-4">
        ...
        <div class="w-3/5">
            @if ($newroom->image)
                <img class="w-full h-auto rounded-lg" src="{{ asset('storage/' . $newroom->image) }}" alt="Main Image">
            @else
    ...
    <div class="flex flex-col gap-4 items-end mt-12">
        <address class="flex items-end not-italic">
            <div class="inline-flex items-end mr-72 text-sm text-gray-900 dark:text-white">
                ...
                <div>
                    <a href="#" rel="author"
                        class="text-xl font-bold text-gray-900 dark:text-gray-800">{{ $newroom['author'] }}</a>
                    <p class="text-base text-gray-700 dark:text-gray-600">Administrator</p>
                    <p class="text-base text-gray-700 dark:text-gray-600"><time pubdate datetime="2025-02-04">Feb. 4,
                            2025</time></p>
                </div>
            </div>
        </address>
